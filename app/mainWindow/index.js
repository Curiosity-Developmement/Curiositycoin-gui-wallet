...
log.debug(`CuriosityCoin wallet started...`);
...
ipcRenderer.on('handleSaveAs', () => {
  ...
  const options = {
    ...
    filters: [
      {
        name: 'CuriosityCoin Wallet File (v0)',
        extensions: ['wallet']
      }
    ]
  };
...
function handleAbout() {
  remote.shell.openExternal(
    'http://github.com/Curiosity-Development/curiositycoin-desktop-wallet#readme'
  );
}
...
function handleIssues() {
  remote.shell.openExternal(
    'http://github.com/Curiosity-Development/curiositycoin-desktop-desktop-wallet/issues'
  );
}
